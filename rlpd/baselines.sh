...
seed=42
XLA_PYTHON_CLIENT_PREALLOCATE=false CUDA_VISIBLE_DEVICES=0 python train_ms3.py configs/base_rlpd_ms3.yml \
  ...
  env.env_id=${env_id} \
  train.dataset_path="~/.maniskill/demos/${env_id}/rl/trajectory.state.pd_ee_delta_pose.physx_cuda.h5" \
  demo_type="rl" config_type="walltime_efficient"

  # env.env_kwargs.control_mode="pd_ee_delta_pose" \
